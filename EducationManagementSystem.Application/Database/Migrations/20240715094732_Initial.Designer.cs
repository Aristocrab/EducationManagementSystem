...
namespace EducationManagementSystem.Application.Database.Migrations
{
    ...
    [Migration("20240715094732_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationManagementSystem.Core.Models.Schedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EducationManagementSystem.Core.Models.Lesson", b =>
                {
                    b.HasOne("EducationManagementSystem.Core.Models.Schedule", null)
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("EducationManagementSystem.Core.Models.Teacher", b =>
                {
                    b.HasOne("EducationManagementSystem.Core.Models.Schedule", "Schedule")
                        .WithMany()
                        .HasForeignKey("ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
